...
let CourseDetailsService = class CourseDetailsService {
    courseRepository;
    constructor(courseRepository) {
        this.courseRepository = courseRepository;
    }
    async create(dto, files, courseId) {
    ...
    async update(id, updateCourseDetailDto) {
        const updated = await this.findOne(id);
        if (!updated) {
            throw new Error("course's post not found!");
        }
        const data = this.courseRepository.merge(updated, updateCourseDetailDto);
...
exports.CourseDetailsService = CourseDetailsService;
exports.CourseDetailsService = CourseDetailsService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(course_detail_entity_1.CourseDetail)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], CourseDetailsService);
//# sourceMappingURL=course-details.service.js.map